# .latexmkrc — reference configuration for all latex/ projects
#
...
# each project needs its own .latexmkrc. See pensee/emc2/.latexmkrc for the
# standard per-project version.

use File::Basename;

# Absolute path to latex/lib/, derived from this file's location.
# Using an absolute path makes it robust regardless of where latexmk is
# invoked from.
my $classes_dir = dirname(__FILE__) . '/lib';
